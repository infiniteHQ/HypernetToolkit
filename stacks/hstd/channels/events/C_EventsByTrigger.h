...
#include "../../../../stacks/hstd/types/primitives/T_Test.h"
...
struct C_TriggerEvents : public HToolkitChannel {

//=============================================================================
// Base & constructors
//=============================================================================
    virtual void constructor(HToolkitType* _type) override {
        Types::T_Test boolean;
        hString test = "popopapapa";
        boolean.set(false, test);
...
//=============================================================================
MOD_CHANNEL(HSTD, C_TriggerEvents);
//=============================================================================
